...
countydem4subset %>% ggplot(aes(y= county_name, x=renter_owner_ratio)) + 
  ...
  labs(x = "Renter to Owner Ratio", 
       title= "Renter-to-Owner Ratios in CA: Top Five and Bottom Five Counties ",
...
ggplot(data = covidvax6top5, aes(x=month, y=county_percent_fullvax, color = county, group = county)) +
  ...
  labs(x="Month", y="Percentage of Fully Vaccinated Individuals", 
       title="Rate of Full COVID-19 Vaccination: Top 5 Counties by Renter-to-Owner Ratio",
       color="County") +
  theme_bw()
```
```{r}
...
ggplot(data = covidvax6bottom5, aes(x=month, y=county_percent_fullvax, color = county, group = county)) +
  geom_point() +
  geom_line() +
  labs(x="Month", y="Percentage of Fully Vaccinated Individuals", 
       title="Rate of Full COVID-19 Vaccination: Bottom 5 Counties by Renter-to-Owner Ratio",
       color="County") +
  theme_bw()
```
