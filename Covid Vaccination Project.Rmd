...
Originally, we split up the top five and bottom five counties to visualize in separate ggplot point graphs, but made the decision to combine the two to visualize and compare together.  
