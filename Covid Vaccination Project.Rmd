...
These data sets relate to our question if being a homeowner status and 
...
a relationship between the homeowner-related to renter rates and
...
and the renter to owner ratio for the counties in California.
...
in 2021. There are more owner households than renter households.
...
```
Figure 2: This graph provides a greater visual aid for the disparity of owning a home
...
counties. We see that overall, those counties with the highest renter-to-owner 
ratios also had the highest vaccination rates for the January-September time
period compared to the bottom five renter-to-owner ratio counties. We start to
see a divide between the groups after April.
